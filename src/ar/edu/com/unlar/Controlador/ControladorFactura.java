...
import ar.edu.com.unlar.Objetos.Detalle;
import ar.edu.com.unlar.Objetos.Factura;
import ar.edu.com.unlar.Util.FechaSQL;
...
"	VALUES ( ?, ?, ?, ?, ?, ?);", PreparedStatement.RETURN_GENERATED_KEYS);
            ...
            if (ps.executeUpdate()>0) {
                ...
                while (rs.next()) {
                    ...
                    ps2 = con.prepareStatement("INSERT INTO public.detalles(\n" +
"	 cantidad, precio_unitario, subtotal, producto, factura)\n" +
"	VALUES ( ?, ?, ?, ?, ?);");
                    
                    for (Detalle detalle : f.getDetalle()) {
